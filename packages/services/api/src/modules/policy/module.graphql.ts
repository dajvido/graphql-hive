...
export default gql`
  ...
  type UpdateSchmeaPolicyResultError implements Error {
    message: String!
    code: String
  }

  type UpdateSchmeaPolicyResultOk {
    updatedPolicy: SchemaPolicy!
    organization: Organization
    project: Project
  }

  type UpdateSchmeaPolicyResult {
    ok: UpdateSchmeaPolicyResultOk
    error: Error
  }
